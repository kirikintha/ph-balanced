    ...
    <>
      <div className="row">
        ...
        <section>
          ...
          <p>
            ...
            growing. If you are asking yourself if AI is right for you - talk to
            us first.
          </p>
          <p>
            We've been in the thick of Generative AI for a while now, and have
            our sea legs. Let us help you!
          </p>
          <p>
            Oh, and spoiler alert: Artificial Intelligent doesn't exist. It is a
            term of use, like "The Cloud". And no, we didn't use GPT to write
            the copy, that's all us.
          </p>
        </section>
      </div>
      <div className="row">
        <section className="order-md-last">
        ...
        <section>
          ...
          <p>
            Let us help you mitigate the risk of finding emerging technologies
            to use. Honestly, we may even propose some battle tested tech
            because sometimes the risk isn't worth it and comes at too high a
            cost.
          </p>
          <p>
            We're here to help you find the right solution at the right time and
            on budget.
          </p>
        </section>
      </div>
      <div className="row">
        ...
        <section>
          ...
          <p>
            ...
            organization. After that, we can find solutions to support your
            deliverables.
          </p>
          <p>
          ...
          <p>
            After you define what success looks like (even on a napkin) we will
            help you execute it.
          </p>
        </section>
      </div>
      <div className="row">
        ...
        <section>
          ...
          <p>
            ...
            non-trivial decision your business can make. It's a riddle, wrapped
            in an enigma, wrapped in a... well you know the quote.
          </p>
          <p>
            We have two decades of experience using technologies as consumers,
            developers, engineers, architects, security specialists and
            managers.
          </p>
          <p>
            We've done everything from making small e-Commerce sites to creating
            brand new products from scratch.
          </p>
          <p>
            If you're stuck, let us guide you. We can help with everything from
            RFPs to analysis.
          </p>
        </section>
      </div>
      <div className="row">
        ...
        <section>
          ...
          <p>
            ...
            back to basics. You're not going to find us posting to up our brand
            through click-bait. Our brand is our word, and that is something in
            short supply these days.
          </p>
          <p>
            Our goal is to find the spaces in between, to figure out where the
      ...
      <div className="row">
        ...
        <section>
          ...
          <p>
            But can you blame us? It's just really fun! And, everyone needs to
          ...
          <p>
            ...
            assistant, because we wanted to see what it could do. For us,
            developing the next move was realizing that there are some really
      ...
      <div className="row">
        ...
        <section>
          ...
          <p>
            Part of our mission is a philosophy we've coined: "The Art and Zen
            of Successful Failure." or "How we learned to love it when things go
            wonk-a-doodle."
          </p>
          <p>
          ...
          <p>
            ...
            a way were your organization can make the most out of your
      ...
      <div className="row">
        ...
        <section>
          ...
          <p>
            Developing the next move is still very much a human endeavor, no
            amount of programming of synapses can reach the computational level
            and experience you have right now - today - reading this with your
            mind.
          </p>
          <p>
            Developing the next move within your organization will be a human
            effort. You, your staff, your stakeholders are all valuable and
      ...
      <div className="row">
        ...
        <section>
          ...
          <p>
            You're going to expect a lot from us, so we're going to expect a lot
            from you in return.
          </p>
          <p>
